...
public class Om_WaitHandle extends Activity {
	private Map<String, String> mMap;
	private ArrayList<OrdermanagerIterm> ordermanagerIterm = new ArrayList<OrdermanagerIterm>();
	...
	private class Task extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			// Toast.makeText(GoodsManagerActivity.this, "task 完成",Toast.LENGTH_SHORT).show();
			// 通知主线程更新UI
		...
		JsonObjectPostRequest jsonObjectPostRequest = new JsonObjectPostRequest(
				url, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						try {
							if (response == null) {
								...
								Toast.makeText(Om_WaitHandle.this, "获取数据成功",Toast.LENGTH_SHORT).show();
								...
								case "200":
									Toast.makeText(Om_WaitHandle.this, "登录成功",Toast.LENGTH_SHORT).show();
									...
									break;
								case "10":
									Toast.makeText(Om_WaitHandle.this, "没有待处理订单",
					...
					public void onErrorResponse(VolleyError error) {
						Toast.makeText(Om_WaitHandle.this, "获取失败，请检查网络",
								Toast.LENGTH_SHORT).show();
...
//				for(int j=0;j<goodsInfoItems.size();j++){
//					if(goodsInfoItems.get(j).getCargoInfoId()==ordermanagerIterm.get(i).getOrderId()){
//						map.put("Start_Place", goodsInfoItems.get(j).getCargoInfoStart());
//						map.put("End_Place", goodsInfoItems.get(j).getCargoInfoEnd());
//						map.put("StartTime", goodsInfoItems.get(j).getCargoInfoDeliTime());
//					}
//				}
				map.put("Start_Place", "----");
				map.put("End_Place", "----");
	...
	public class ItemClickEvent implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(Om_WaitHandle.this, OrderWaitActivity.class);
