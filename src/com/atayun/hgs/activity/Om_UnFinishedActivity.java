...
public class Om_UnFinishedActivity extends Activity {
		...
		JsonObjectPostRequest jsonObjectPostRequest = new JsonObjectPostRequest(
				url, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						try {
							if (response == null) {
								...
								Toast.makeText(Om_UnFinishedActivity.this, "获取数据成功",
										Toast.LENGTH_SHORT).show();
								...
								case "200":
									Toast.makeText(Om_UnFinishedActivity.this, "登录成功",Toast.LENGTH_SHORT).show();
									...
									break;
								case "10":
									Toast.makeText(Om_UnFinishedActivity.this, "没有未完成订单",
											Toast.LENGTH_SHORT).show();
									break;
					...
					public void onErrorResponse(VolleyError error) {
						Toast.makeText(Om_UnFinishedActivity.this, "获取失败，请检查网络",
								Toast.LENGTH_SHORT).show();
	...
	public class ItemClickEvent implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(Om_UnFinishedActivity.this, OrderWaitActivity.class);
