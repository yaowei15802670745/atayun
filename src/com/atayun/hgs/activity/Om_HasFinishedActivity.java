...
public class Om_HasFinishedActivity extends Activity {
		...
		JsonObjectPostRequest jsonObjectPostRequest = new JsonObjectPostRequest(
				url, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						try {
							if (response == null) {
								...
								Toast.makeText(Om_HasFinishedActivity.this, "获取数据成功",
										Toast.LENGTH_SHORT).show();
								...
								case "200":
									Toast.makeText(Om_HasFinishedActivity.this, "登录成功",Toast.LENGTH_SHORT).show();
									...
									break;
								case "10":
									Toast.makeText(Om_HasFinishedActivity.this, "没有已完成订单",
											Toast.LENGTH_SHORT).show();
									break;
					...
					public void onErrorResponse(VolleyError error) {
						Toast.makeText(Om_HasFinishedActivity.this, "获取失败，请检查网络",
								Toast.LENGTH_SHORT).show();
	...
	public class ItemClickEvent implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(Om_HasFinishedActivity.this, OrderWaitActivity.class);
