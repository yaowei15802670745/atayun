...
public class BestMachDetailgoodsActivity extends Activity implements OnClickListener{
	...
	private String cagoCpName;
	private String cargoInfoStart;
...
//	private String cargoInfoStart2="长沙中南物流园X06—104";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_bestdetailgoods);
		//使用Bundle获取来自BestSquareGoodsActivity的数据
		...
		cagoCpName=bundle.getString("cagoCpName");
	...
	private void initView() {
		...
		//下面都是设置字体颜色
		setPartColor("公司/个人："+cagoCpName, company, 0, 5);
...
//			    Toast.LENGTH_SHORT).show();
		...
		case R.id.detail_back:
			Intent intent=new Intent(BestMachDetailgoodsActivity.this,BestSquareGoodsActivity.class);
		    finish();
			startActivity(intent);
