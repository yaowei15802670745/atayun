...
public class OtherGoodsDetailActivity extends Activity implements OnClickListener{
...
//		private String cargoInfoStart2="长沙中南物流园X06—104";
		...
		private void initView() {
			...
			//下面都是设置字体颜色
			setPartColor("公司资职："+cagoCpName, company, 0, 5);
...
//				    Toast.LENGTH_SHORT).show();
			...
			case R.id.detail_back:
				Intent intent=new Intent(OtherGoodsDetailActivity.this,MatchGoodsSqureActivity.class);
			    finish();
				startActivity(intent);
