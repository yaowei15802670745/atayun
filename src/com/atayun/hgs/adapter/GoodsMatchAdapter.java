...
import com.atayun.hgs.adapter.GoodsManaAdapter.MyModule;
...
public class GoodsMatchAdapter extends BaseAdapter {
	private List<Map<String ,Object>> data;
	private LayoutInflater layoutInflater;
	private Context context;
	public GoodsMatchAdapter(Context context,List<Map<String ,Object>> data){
	...
	//组件集合
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView==null){
				...
				//实例化组件
				convertView=layoutInflater.inflate(R.layout.checkgoodslistitem, null);
			...
			myMpdule.Match_num.setText((String)data.get(position).get("mareNum"));
