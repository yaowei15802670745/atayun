...
//		bucket.setBucketACL(AccessControlList.PUBLIC_READ);
		...
		// 设置CDN加速域名时， 权限至少是公共读
//		bucket.setCdnAccelerateHostId("oss-cnhangzhou.aliyuncs.com");

		// 可选地进行Bucket cname的设置
//		bucket.setBucketHostId("oss-cnhangzhou.aliyuncs.com");
	...
	public void asyncUpload() {
		...
		OSSData data = ossService.getOssData(bucket, "protraitImages");
		data.setData(dataToUpload, "text/txt");
